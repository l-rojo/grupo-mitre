      ...
      <v-list dense>
        ...
        <template v-if="esAdmin || esMitre">
          <v-list-group>
            <v-list-tile slot="activator">
              <v-list-tile-content>
                <v-list-tile-title> Parámetros </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile :to="{ name: 'obrasocial' }">
              ...
              <v-list-tile-content>
                <v-list-tile-title> Obra Social </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile :to="{ name: 'nomenclador' }">
              ...
              <v-list-tile-content>
                <v-list-tile-title> nomenclador </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list-group>
        </template>
        ...
        <template v-if="esAdmin || esMitre || esPrestador">
          <v-list-group>
            <v-list-tile slot="activator">
              <v-list-tile-content>
                <v-list-tile-title> Facturacion </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile :to="{ name: 'FacturacionMes' }">
              ...
              <v-list-tile-content>
                <v-list-tile-title> Facturacion Mensual </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
            <v-list-tile v-if="esAdmin || esMitre" :to="{ name: 'Resumen' }">
              <v-list-tile-action>
            ...
            <v-list-tile :to="{ name: 'InformeFacturacion' }">
              ...
              <v-list-tile-content>
                <v-list-tile-title> Informe Facturacion </v-list-tile-title>
              </v-list-tile-content>
            </v-list-tile>
          </v-list-group>
        </template>
