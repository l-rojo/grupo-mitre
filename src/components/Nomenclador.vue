<template>
 <v-layout align-start>
        <v-flex>
         <v-card>
         <v-toolbar-title>
            <v-icon> mdi-domain</v-icon> Grupo Mitre: Nomenclador 
           </v-toolbar-title>
           <v-card-text>
                    <v-container grid-list-md>
                        <v-layout wrap>
                         ...
                         <v-flex xs12 sm6 md6>
                         <v-select v-model="nombre"
                        :items="ListObraSocial" label="Seleccionar Obra sociales">
                        </v-select>
                         </v-flex>
                         <v-flex xs12 sm6 md6>
                ...
                <v-card>
                    ...
                    <v-container grid-list-md>
                        <v-layout wrap>
                         ...
                         <v-flex xs12 sm3 md3>
                            <v-text-field v-model="IdNomenclador" label="IdNomenclador"></v-text-field>
                        </v-flex>
                        ...
                        <v-flex xs12 sm12 md12>
                            <v-text-field v-model="NombreTipoPractica" label="NombreTipoPractica"></v-text-field>
                        </v-flex>
            ...
            >
                <template slot="items" slot-scope="props">
                    <td >
                     ...
                     <td >{{ props.item.NombreTipoPractica }}</td>
    ...
    export default {
                ...
                headers: [
                  ...
                  { text: 'IdNomenclador', value: 'IdNomenclador', sortable: false },
                   { text: 'Codigo', value: 'Codigo', sortable: false },
                    ...
                    { text: 'NombreTipoPractica', value: 'NombreTipoPractica', sortable: false  },                   
        ...
        methods:{
            ...
            listar(){
              let me=this;
             // console.log("me",me);
              axios.get('ListadoNomenclador').then(function(response){
            ...
            SelectedObraSocial(){
              ...
              var empresasArray=[];
              axios.get('ListadoObraSocial').then(function(response){
                empresasArray=response.data;
                console.log (response.data);
                empresasArray.map(function(x){
                    me.ListObraSocial.push({text: x.nombre,value:x.nombre})
                    });   
              }).catch(function(error){
                  console.log (error);
              });
            ...
            editItem (item) {
                ...
                this.IdNomenclador=item.IdNomenclador
                this.NombreTipoPractica=item.NombreTipoPractica
